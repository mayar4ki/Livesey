...
export const description = 'Enhance liquidity, Transform how you manage assets today, focusing on transparency and decentralization.';
  ...
  features: [
    {
      ...
      description: 'Easily uncover untapped areas to explore and expand your reach effortlessly and effectively.',
    },
    {
      icon: BookCheck,
      title: 'Build Authority',
      description: 'Create valuable content that resonates, inspires trust, and positions you as an expert.',
    },
    {
      icon: ChartPie,
    ...
    },
    {
      ...
      description: 'Streamline your processes by automating repetitive tasks, saving time and reducing effort.',
    },
    {
      icon: Zap,
