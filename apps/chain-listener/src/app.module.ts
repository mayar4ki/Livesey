...
import { BitInvalidatorUpdatedEventLListenerModule } from './modules/order-canceled-event-listener copy/order-canceled-event-listener.module.js';
...
@Module({
  imports: [
    ...
    BitInvalidatorUpdatedEventLListenerModule,
