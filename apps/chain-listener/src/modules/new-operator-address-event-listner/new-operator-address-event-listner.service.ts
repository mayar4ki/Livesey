...
@Injectable()
export class NewOperatorAddressEventListnerService implements OnModuleInit, OnModuleDestroy {
  private unwatch?: Unwatch;
  private readonly logger = new Logger(NewOperatorAddressEventListnerService.name);
