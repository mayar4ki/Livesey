...
import { TokenCreatedWorkerService } from './modules/token-created-worker/token-created-worker.service.js';
...
async function bootstrap() {
  ...
  app.get(TokenCreatedWorkerService); // triggers onModuleInit to start worker
